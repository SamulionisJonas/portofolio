...
export default function CopyTextToClipboard({ copyText }: any) {
	...
	return (
		<button
			{...(isCopied && {
				className:
					"after:content-['Copied'] after:fixed after:px-1 after:py-0.5 after:bg-white after:-top-0 after:-right-8 after:rounded after:text-gray-900 after:text-xs after:font-medium after:shadow-md after:z-10 after:transition-opacity after:duration-700 after:ease-in after:opacity-100 after:delay-1000 after:cursor-default",
			})}
